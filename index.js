...
Aşağıdakileri yapmak için sonCesitiKaldir işlevini kullanın:
   1. Bir dizi alın
   2. Alınan diziden son öğeyi kaldırına
...
function sonCesitiKaldir(tatlarDizisi,sonCesitiKaldir){
  tatlarDizisi.pop(sonCesitiKaldir);
  return tatlarDizisi;
}
...
// Örnek kullanım
var tatlar = ["Çikolata", "Vanilya", "Çilek", "Muz"];
var indeks = 2;

var cesit = indekstekiCesitiGetir(tatlar, indeks);
console.log(cesit); // Çilek
